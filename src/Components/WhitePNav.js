...
const WhitePNav = ({ setNavOpen }) => {
  return (
    <div>
      <div className="lg:hidden flex px-4 items-center justify-between bg-[#181C1F] text-white w-full top-0 fixed py-4">
        <div className="flex items-center gap-3">
          <AiOutlineMenu onClick={() => setNavOpen(true)} className="text-2xl" />
          <img
